import torch
from e2_tts_pytorch.e2_tts_crossatt import E2TTS, DurationPredictor
from e2_tts_pytorch.e2_tts_crossatt import MelSpec, EncodecWrapper

from torch.optim import Adam
from datasets import load_dataset

#from e2_tts_pytorch.trainer import (
from e2_tts_pytorch.trainer_multigpus_alldatas import (
    HFDataset,
    Text2AudioDataset,
    Text2SpeechDataset,
    E2Trainer,
...
def main():
    ...
    optimizer = Adam(e2tts.parameters(), lr=1e-5)
    ...
    trainer = E2Trainer(
        ...
        log_file = '/ailab-train/speech/zhanghaomin/e2/test/e2tts.txt',
        tensorboard_log_dir = '/ailab-train/speech/zhanghaomin/e2/test/',
        max_grad_norm = 0.2,
    ...
    train_dataset = Text2AudioDataset(None, "train_val_audioset_sl", None, None, None, -1, batch_size, stft, 0, trainer.is_main, SCORE_THRESHOLD_TRAIN, "/zhanghaomin/codes2/audiocaption/msclapcap_v1.list", -1.0, 6, [False]*4+[True]*4, None, trainer.device_id, None, e2tts.video_encoder, None, trainer.num_processes, "/ailab-train/speech/zhanghaomin/scps/VGGSound/train.scp")
    ...
    #eval1_dataset, eval2_dataset, eval4_dataset = None, None, None
    trainer.train((train_dataset, eval1_dataset, eval2_dataset, eval3_dataset, eval4_dataset), epochs, batch_size, num_workers=12, save_step=5000)
