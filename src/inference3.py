...
if len(sys.argv) >= 6:
    ...
    #ckpt = "/ailab-train/speech/zhanghaomin/e2/e2_tts_experiment_v2a_encodec_more_more_more_more/80000.pt"
    ckpt = "/ailab-train/speech/zhanghaomin/e2/e2_tts_experiment_v2a_encodec_more_more_more_more_contra2/club_x1x2_cond_l1_b6_f1_more_moreneg_more_2500.pt"
    #ckpt = "/ailab-train/speech/zhanghaomin/e2/e2_tts_experiment_v2a_encodec_more_more_more_more_nospeech_vgganimation/_60000.pt"
    #ckpt = "/ailab-train/speech/zhanghaomin/e2/e2_tts_experiment_v2a_encodec_more_more_more_more_nospeech_animation/_60000.pt"
    #ckpt = "/ailab-train/speech/zhanghaomin/e2/e2_tts_experiment_v2a_encodec_small_nospeech_vgganimation/65000.pt"
    drop_prompt = True
    test_scp = "/ailab-train/speech/zhanghaomin/scps/VGGSound/test.scp"
    #test_scp = "/ailab-train/speech/zhanghaomin/datas/v2adata/all.scp"
    start = 0
    end = 10
    out_dir = "./outputs/"
...
from e2_tts_pytorch.trainer_multigpus_alldatas import HFDataset, Text2AudioDataset
