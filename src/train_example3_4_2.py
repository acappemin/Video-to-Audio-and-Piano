import torch
from e2_tts_pytorch.e2_tts_crossatt3_2 import E2TTS, DurationPredictor
from e2_tts_pytorch.e2_tts_crossatt3_2 import MelSpec, EncodecWrapper

from torch.optim import Adam
from datasets import load_dataset

#from e2_tts_pytorch.trainer import (
from e2_tts_pytorch.trainer_multigpus_alldatas3_2 import (
    HFDataset,
    Text2AudioDataset,
    Text2SpeechDataset,
    E2Trainer,
...
def main():
    ...
    trainer = E2Trainer(
        ...
        checkpoint_path = '/ailab-train/speech/zhanghaomin/e2/e2_tts_experiment_v2a_encodec_more_more_more_more_piano6/7.500.pt',
        log_file = '/ailab-train/speech/zhanghaomin/e2/e2_tts_experiment_v2a_encodec_more_more_more_more_piano6/e2tts.txt',
        tensorboard_log_dir = '/ailab-train/speech/zhanghaomin/e2/e2_tts_experiment_v2a_encodec_more_more_more_more_piano6/',
        max_grad_norm = 0.2,
    ...
    #eval1_dataset, eval2_dataset, eval3_dataset, eval4_dataset, eval5_dataset, eval6_dataset = None, None, None, None, None, None
