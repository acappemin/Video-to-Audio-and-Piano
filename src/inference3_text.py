...
def main():
    ...
    eval_dataset = Text2AudioDataset(None, ["val_audiocaps", test_scp, start, end], None, None, None, -1, -1, stft, 0, True, SCORE_THRESHOLD_TRAIN, "/zhanghaomin/codes2/audiocaption/msclapcap_v1.list", -1.0, 1, None, None, 0, None, video_encoder="clip_vit")
    ...
    for b, batch in enumerate(eval_dataloader):
        ...
        audio_path = out_dir + str(b+start).zfill(8) + ".wav"
